...
object AllApi {
    ...
    private const val CHARACTERS_BY_IDS_PATH = "character/{ids}"
    const val CHARACTERS_BY_IDS = RICK_AND_MORTY_BASE_URL + CHARACTERS_BY_IDS_PATH

    private const val LOCATIONS_PATH = "location/"
    const val LOCATIONS = RICK_AND_MORTY_BASE_URL + LOCATIONS_PATH
    private const val SINGLE_LOCATION_PATH = "location/{id}"
    const val SINGLE_LOCATION = RICK_AND_MORTY_BASE_URL + SINGLE_LOCATION_PATH
